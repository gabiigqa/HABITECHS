...
{
    /// <inheritdoc />
    public partial class MigracionInicialSupabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuardId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NitroId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_AspNetUsers_ResidentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parcels_AspNetUsers_ResidentId",
                        column: x => x.ResidentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidentCode = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: false),
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ParentProfileId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolutionImageUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFixedQRCode = table.Column<bool>(type: "boolean", nullable: false),
                    ResidentId = table.Column<string>(type: "text", nullable: false),
                    ...
                    ApprovedByGuardId = table.Column<string>(type: "text", nullable: true),
                    IsEntryCompleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
